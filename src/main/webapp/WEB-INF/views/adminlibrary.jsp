...
<body>
	<div class="topnav">
		...
		<div class="topnav-right">
			...
			<a href="${pageContext.request.contextPath}/adminlibrary" class="active">Library</a>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>${b.description}</td>
                                    <td>
                                    <a href="${pageContext.request.contextPath}/getadminbook/${b.id}/${currentuser.id}">Get</a>
                                    <a href="${pageContext.request.contextPath}/deletebook/${b.id}">Delete</a>
                                    <a href="${pageContext.request.contextPath}/updatebook/${b.id}">Update</i></a>
                                    </td>
                                </tr>
                                </c:forEach>
