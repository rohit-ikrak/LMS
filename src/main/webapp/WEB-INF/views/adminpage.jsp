...
<body>
	<div class="topnav">
		...
		<div class="topnav-right">
			<a href="${pageContext.request.contextPath}/adminpage" class="active">Profile</a> 
        ...
        <div class="container mt-3">
            ...
            <div class="border border-danger my-5">
                <div class="col-md-8 offset-md-2 mt-5 mb-3">    
                    <form action="${pageContext.request.contextPath}/adminpage/updateadmindata" method="post">
	...
	<footer class="bg-body-tertiary text-center text-lg-start">
		...
		<div class="text-center p-3" style="background-color: #d6e7eb;">
			© 2024 Copyright: <a class="text-body" href="#link">rk-lms.com</a>
		</div>
		<!-- Copyright -->
	</footer>
